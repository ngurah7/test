<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="#">Laporan Pembelian Barang</a></li>
    </ol>
  </section>
  <br>
  <?php
              ...
              <div class="box-header">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tfoot>
                    <tr>
                      <td colspan="5"><strong><center>Total Pembelian</center></strong> </td>
                  ...
                  <div class="row">
                    <div style="padding: 1%">
                      ...
                      ");
                        ...
                        <form method="post" action="pages/laporan/print_laporan_pembelian.php" target="_blank">
