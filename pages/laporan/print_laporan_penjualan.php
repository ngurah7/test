					...
					<div style="padding-left: 0px;">
						...
						<table border="0" style="margin-top: 3%">
							...
							<tr>
								...
								<td align="center"><h3 style="margin:0px;">Laporan Data Penjualan</h3></td>
							</tr>
							<tr>
								<td></td>
			...
			<table border="1" width="800">
				...
				<tbody>
					...
					<tr>
						...
						<td style="padding: 8px"><?php echo $data->id_penjualan; ?></td>
						<td style="padding: 8px"><?php echo $data->tgl_penjualan; ?></td>
						<td style="padding: 8px"><?php echo $data->nama_user; ?></td>
				...
				<tfoot>
				<tr>
					<td colspan="5" style="text-align: center; padding: 8px;"><strong>Total Penjualan</strong></td>
