...
<div class="content-wrapper">
  ...
  $sql_nota = "SELECT * FROM penjualan order by id_penjualan desc limit 1";
  $cek_nota = $connect->query($sql_nota)->rowCount();
  if ($cek_nota > 0) {
  $query_nota = $connect->query($sql_nota);
  $data_nota = $query_nota->fetch(PDO::FETCH_OBJ);
  $kodeBarang = $data_nota->id_penjualan;
  $noUrut = (int) substr($kodeBarang, 3, 3);
  $noUrut++;
  $id_nota = "PJ-" . sprintf("%03s", $noUrut);
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <!-- form start -->
              <form class="form-horizontal" method="post" id="formAdd" action="pages/transaksi/proses_penjualan.php?aksi=add_keranjang">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select class="form-control selectpicker" data-live-search="true" name="id_barang" required="">
                        ...
                        ?>
                        <option value="<?php echo $data->id_barang ?>"><?php echo $data->nama_barang; ?> ( Harga Satuan : <?php echo "Rp " . number_format($data->harga_jual,0,',','.'); ?> / Stok : <?php echo $data->stok; ?>)</option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                          <form method="post" id="formEdit" action="pages/transaksi/proses_penjualan.php?aksi=edit_cart&id=<?php echo($id_cart) ?>">
                            <td><?php echo $no++; ?></td>
                          ...
                          <td>
                            ...
                            <a data-url="pages/transaksi/proses_penjualan.php?aksi=delete&id=<?php echo($id_cart) ?>" href="" class="btn btn-danger confirm_delete"><i class="fa fa-times"></i></a>
                          </td>
                        </form>
                        <?php } ?>
                      </tr>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                          <div class="box-header with-border">
                            ...
                            <!-- form start -->
                            <form class="form-horizontal" method="post" id="formBayar" action="pages/transaksi/proses_penjualan.php?aksi=add_pembayaran">
                              <div class="box-body">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label class="col-md-3 control-label font-label">Total Belanja</label>
                                  <div class="col-md-6">
                                ...
                                <div class="form-group">
                                  <label class="col-md-3 control-label font-label">Pembayaran</label>
                                  <div class="col-md-6">
                                    <input type="text" name="harga" id="harga1" class="form-control font-label" placeholder="0" required="" onkeyup="autoRupiah();pembayaran(); ">
                                  </div>
                                </div>
                                <div class="form-group">
                                  <label class="col-md-3 control-label font-label">Kembalian</label>
                                  <div class="col-md-6">
                                    <input type="text" name="kembalian" id="kembalian" class="form-control font-label" placeholder="0" readonly="">
                                  </div>
                                </div>
                                ...
                                <div class="box-footer">
                                  ...
                                  <div class="col-md-2">
                                    <a data-url="pages/transaksi/proses_penjualan.php?aksi=delete_cart" href="" class="btn btn-danger confirm_cart">Batal Transaksi</a>
                                  </div>
                                  <div class="col-md-1">
                                    <a href="?page=penjualan" class="btn btn-warning pull-right">Kembali</a>
